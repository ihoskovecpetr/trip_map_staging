export default {
  ...
  colors: {
    cta_color: "#f6aa1c", // "#EF233C", // "#25CB9E", // green-blue "#fe6769", // red CTA color
    primary: "#001427", // "#2B2D42", // "#1F3E76", // blue - primary button and link color
  ...
  forms: {
    ...
    input: {
      borderRadius: 8,
      borderColor: "whitish_paper_blue",
      height: 60,
      "&:focus": {
        borderColor: "primary",
