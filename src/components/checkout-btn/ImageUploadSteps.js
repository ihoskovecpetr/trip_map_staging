...
export default function ImageUploadSteps({ isUploadPending, imageBase64Created, fileSizeMB, lightbox, setLightbox }) {
            ...
            >
                {[
                    <Step key="1">
                        <StyledStepLabel>
                            <StepsText>
                                {`${imageBase64Created ? t('checkout.designCreated') : t('checkout.processingDesign')}`}
                                {!imageBase64Created && (
                                    <WrapSpan>
                                        <UnderlineLoader />
                                    </WrapSpan>
                    ...
                    <Step key="3">
                        <StyledStepLabel>
                            <StepsText>
                                {imageBase64Created
                                    ? `${isUploadPending ? t('checkout.saving') : t('checkout.saved')}`
                                    : t('checkout.waitingForDesign')}
