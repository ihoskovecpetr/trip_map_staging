...
export default function StepPathOrWithout({ map, index }) {
    ...
    const withPathUrl =
        'https://res.cloudinary.com/dkyt8girl/image/upload/v1657874621/Screen_Shot_2022-07-15_at_6.33.36_pm_zbekyb.png'
        ...
        <StepContainer isMobile={isMobile}>
            ...
            <OptionContainer>
                ...
                >
                    ...
                    <ItemHeading active={!isJourneysEnabled}>{t('step.withoutPath')}</ItemHeading>
                </OptionItem>
                <OptionItem
                    onClick={() => {
                ...
                >
                    ...
                    <ItemHeading active={isJourneysEnabled}>{t('step.withPath')}</ItemHeading>
                </OptionItem>
            </OptionContainer>
        </StepContainer>
    )
...
const StyledImg = styled.img`
    ...
    border-radius: 3px;
    color: ${color('muted')};
    box-shadow: ${({ active }) => (active ? '0px 0px 0px 3px' : '0px 0px 0px 0px')};
