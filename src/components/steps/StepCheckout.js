...
export default function StepCheckout({ map, activeMapStyleName, snapMapInstance, index, children }) {
    ...
    return (
        <StepContainer isMobile={isMobile}>
            ...
            <CheckoutCta map={map} children={children} snapMapInstance={snapMapInstance} />
        </StepContainer>
    )
}
