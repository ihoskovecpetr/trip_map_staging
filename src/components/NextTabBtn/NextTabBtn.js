...
function NextTabBtn({ onClick, children, width = '100%', isLoadingOnClick, isDisabled, disabledText, margin, price }) {
        ...
        <Container margin={margin}>
            ...
            >
                {disabledText && isDisabled ? (
                    ...
                    <TextWrap>
                        {`${children}`} {price && <span>{price ? getFormatedPriceString(price, currency) : ''}</span>}
