...
const resizeFrameDiv = ({
      ...
      if (framedVariantObj) {
            const extraFrame =
                  (baseLongSize * framedVariantObj.frameOutsideKoef) /
                  CURRENT_PIXEL_RATIO;
            ...
            Object.assign(frameDiv.style, {
                  ...
                  top: 0,
                  left: 0,
                  outline: `${extraFrame + 0}px solid ${
                        framedVariantObj.frameColor
                  }`,
...
export default function RootContainer() {
      ...
      useEffect(() => {
            if (map) {
                  ...
                  const existingLayoutCanvas = document.getElementById(
                        "layout_canvas"
                  );
                  if (existingLayoutCanvas) {
                        existingLayoutCanvas.parentNode.removeChild(
                              existingLayoutCanvas
                        );
                  }
