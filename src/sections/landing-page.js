...
const data = {
      subTitle: "",
      title: "Vytvořte si stylovou vzpomínku na cesty", //  "Vytvořte si vlastní mapu na vzpomínku",
      features: [
            {
                  id: 1,
                  imgSrc: Briefcase,
...
const styles = {
      sectionContainer: {
            ...
            "&::before": {
                  ...
                  left: 0,
                  background:
                        "linear-gradient(-157deg, #F6FAFD, #F9FCFC, #FCFDFC)",
                  height: [350, 550, "60%"],
                  width: "50%",
                  zIndex: -1,
      ...
      backgroundDiv: {
            ...
            backgroundSize: ["100% auto", "cover"],
            boxShadow: [
                  "inset 0 0 0 2000px rgba(255, 255, 255, 0.1)",
                  null,
                  "unset",
            ],
            backgroundOrigin: "content-box",
